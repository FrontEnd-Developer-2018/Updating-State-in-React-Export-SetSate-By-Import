...
class Car extends React.Component {
  constructor() {
    ...
    FaireSortirLeTHISsetStateOutDeComposent =
      FaireSortirLeTHISsetStateOutDeComposent.bind(this);
  }
  ...
  render() {
    return (
      <div>
        <button
          onClick={() => this.setState({ vitesse: this.state.vitesse + 10 })}
        >
          Changer de vitesse
        </button>
